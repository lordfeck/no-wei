...
window.addEventListener("load", function() {
    // Detect Chrome only. Edge and Opera TBD
    ...
    const hasDismissed = window.localStorage["nowei-hasDismissed"];

    // User agent is okay, or has dismissed banner
    if (uaHasFox || uaHasOpera || uaHasEdge || allowDismissal && hasDismissed === "true") { 
        return;
        ...
        <p class="nowei-p">Regrettably, Google is changing the web for the worse. By using Chrome, you are unwittingly helping Google consolidate control over the open Internet through the disastrous WEI standard. This is depriving internet freedom from you and billions of others. Do not help them any further; take a stand! 
        Consider using a browser that respects your freedom such as <a href="https://www.mozilla.org/en-GB/firefox/new/" target="_blank">Firefox</a>, <a href="https://brave.com/" target="_blank">Brave</a> or <a href="https://vivaldi.com/" target="_blank">Vivaldi</a>.</p>
        ...
        if (allowDismissal) {
            ...
            dismissLink.addEventListener("click", function(e) {
                e.preventDefault();
                window.localStorage["nowei-hasDismissed"] = "true";
                noWei.remove();
            });
        }
    }
